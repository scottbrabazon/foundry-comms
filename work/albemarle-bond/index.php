...
<!--<![endif]-->
	<head>
		...
		<link rel="canonical" href="http://www.foundrycomms.co.uk/work/albemarle-bond/" />
	...
	<body>
		...
		<header id="albemarle-bond-masthead" class="masthead flexbox">
			<div class="masthead-content main-container flexbox">
				<div class="headlines">
					<h1>Albemarle Bond</h1>
					<div class="rule">
		...
		<section id="albemarle-bond-intro" class="main-container">
			...
			<div class="flexbox listen">
				...
				<div class="listen-copy">
					...
					2. It had a secret weapon – its staff. Many of their customers know the branch staff by name and the company has a unique part to play in the local community.</p>
				</div>	
			</div>
			<hr />
		...
		<section id="case-study-examples">
			...
			<div id="albemarle-bond9" class="main-container">
				<div class="centered">
					...
					<p>The new website design is fully responsive on mobile and tablets. It features videos of friendly staff members offering helpful advice, plus an e-commerce solution that makes it easier to purchase pre-owned gold jewellery and premium watch brands online.</p>
				</div>
			</div>
